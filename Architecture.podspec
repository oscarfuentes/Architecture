...
Pod::Spec.new do |s|
  ...
  s.author             = { "OSCAR FUENTES" => "oscar_fuentes@brown.edu" }
  # Or just: s.author    = "OSCAR FUENTES"
  # s.authors            = { "OSCAR FUENTES" => "oscar_fuentes@brown.edu" }
  # s.social_media_url   = "http://twitter.com/OSCAR FUENTES"
  ...
  s.source_files  = "Architecture", "Architecture/**/*.{h,m,swift}"
  s.exclude_files = "Architecture/Exclude"
